...
def get_train_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Data augmentation parameters for training')
    parser.add_argument('--root_dir', type=str, default='data/prostate/PROSTATE/train')
    parser.add_argument('--dest_dir', type=str, default='data/prostate/PROSTATE-Aug/train')
    parser.add_argument('--n_aug', type=int, default=4) # 4 for train
...
def get_val_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Data augmentation parameters')
    parser.add_argument('--root_dir', type=str, default='data/prostate/PROSTATE/val')
    parser.add_argument('--dest_dir', type=str, default='data/prostate/PROSTATE-Aug/val')
    parser.add_argument('--n_aug', type=int, default=0) # 0 for val
    parser.add_argument('--flip', type=str2bool, default=True)
    parser.add_argument('--mirror', type=str2bool, default=True)
    parser.add_argument('--rotate', type=str2bool, default=True)
    parser.add_argument('--scale', type=str2bool, default=False)
