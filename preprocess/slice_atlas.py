...
def main(args: argparse.Namespace):
    ...
    #     id_list: List[str] = f.read().splitlines()
    ...
    for mode, split_ids in zip(["train", "val"], [training_ids, validation_ids]):
        ...
        # for k,ids in enumerate(split_ids):
        #     # print("{}/{}".format(k,len(split_ids)))
        #     pfun(ids)


def get_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Slicing parameters')
    parser.add_argument('--source_dir', type=str, default='data/atlas/ATLAS_R1.1')
    parser.add_argument('--dest_dir', type=str, default='data/atlas/ATLAS')
    parser.add_argument('--id_list', type=str, default='data/atlas/ATLAS_R1.1/uniq_ids')

    # parser.add_argument('--img_dir', type=str, default="IMG")
    # parser.add_argument('--gt_dir', type=str, default="GT")
    parser.add_argument('--shape', type=int, nargs="+", default=[208, 256])
