...
class AtlasDetection(torchvision_wj.datasets.AtlasDetection):
    def __init__(self, root, image_folder, gt_folder, transforms, 
                 transform_generator=None, visual_effect_generator=None,
                 transform_parameters=TransformParameters()):
        super(AtlasDetection, self).__init__(root, image_folder, gt_folder)
...
def get_atlas(root, image_folder, gt_folder, transforms, mode='instances', 
                 transform_generator=None, visual_effect_generator=None):
    ...
    dataset = AtlasDetection(root, image_folder, gt_folder, transforms=transforms,
