...
if __name__ == "__main__":
    ...
    n_exp = args.n_exp
    cfg = {'train_params': {'patience': 4, 'lr': 5e-4, 'batch_size': 80}, 
    ...
    if n_exp==0: # full supervision
        config1 = {'net_params': {'softmax': False, 'losses': 
                   ...
                   'save_params': {'experiment_name': 'enet_all_fs'}}
        _C_array = []
        for c in [config1]:
        ...
        config2 = {'net_params': {'softmax': False, 'losses': 
                                [('MILUnaryParallelSigmoidLoss',{'angle_params':(-40,41,10), 'mode':'focal', 'focal_params':{'alpha':0.25, 'gamma':2.0, 'sampling_prob':1.0}},1),
                                 ('MILPairwiseLoss',{'softmax':False, 'exp_coef':-1},10)]},
                   'save_params': {'experiment_name': 'enet_parallel_focal_40_10_unary_pair'}}
        config3 = {'net_params': {'softmax': False, 'losses': 
                                [('MILUnaryParallelSigmoidLoss',{'angle_params':(-40,41,20), 'mode':'focal', 'focal_params':{'alpha':0.25, 'gamma':2.0, 'sampling_prob':1.0}},1),
                                 ('MILPairwiseLoss',{'softmax':False, 'exp_coef':-1},10)]},
                   'save_params': {'experiment_name': 'enet_parallel_focal_40_20_unary_pair'}}
        config4 = {'net_params': {'softmax': False, 'losses': 
                                [('MILUnaryParallelSigmoidLoss',{'angle_params':(-60,61,30), 'mode':'focal', 'focal_params':{'alpha':0.25, 'gamma':2.0, 'sampling_prob':1.0}},1),
                                 ('MILPairwiseLoss',{'softmax':False, 'exp_coef':-1},10)]},
                   'save_params': {'experiment_name': 'enet_parallel_focal_60_30_unary_pair'}}
        _C_array = []
        ...
        config1 = {'net_params': {'softmax': False, 'losses': 
                                [('MILUnaryApproxSigmoidLoss',{'mode':'all', 'method':'expsumr', 'gpower':4},1),
                                 ('MILPairwiseLoss',{'softmax':False, 'exp_coef':-1},10)]},
                   'save_params': {'experiment_name': 'enet_all_unaryapprox_expsumr=4_pair'}}
        config2 = {'net_params': {'softmax': False, 'losses': 
                                [('MILUnaryApproxSigmoidLoss',{'mode':'all', 'method':'expsumr', 'gpower':6},1),
                                 ('MILPairwiseLoss',{'softmax':False, 'exp_coef':-1},10)]},
                   'save_params': {'experiment_name': 'enet_all_unaryapprox_expsumr=6_pair'}}
        config3 = {'net_params': {'softmax': False, 'losses': 
                                [('MILUnaryApproxSigmoidLoss',{'mode':'all', 'method':'expsumr', 'gpower':8},1),
                                 ('MILPairwiseLoss',{'softmax':False, 'exp_coef':-1},10)]},
                   'save_params': {'experiment_name': 'enet_all_unaryapprox_expsumr=8_pair'}}
        _C_array = []
        ...
        config1 = {'net_params': {'softmax': False, 'losses': 
                                [('MILUnaryApproxSigmoidLoss',{'mode':'all', 'method':'explogs', 'gpower':4},1),
                                 ('MILPairwiseLoss',{'softmax':False, 'exp_coef':-1},10)]},
                   'save_params': {'experiment_name': 'enet_all_unaryapprox_explogs=4_pair'}}
        config2 = {'net_params': {'softmax': False, 'losses': 
                                [('MILUnaryApproxSigmoidLoss',{'mode':'all', 'method':'explogs', 'gpower':6},1),
                                 ('MILPairwiseLoss',{'softmax':False, 'exp_coef':-1},10)]},
                   'save_params': {'experiment_name': 'enet_all_unaryapprox_explogs=6_pair'}}
        config3 = {'net_params': {'softmax': False, 'losses': 
                                [('MILUnaryApproxSigmoidLoss',{'mode':'all', 'method':'explogs', 'gpower':8},1),
                                 ('MILPairwiseLoss',{'softmax':False, 'exp_coef':-1},10)]},
                   'save_params': {'experiment_name': 'enet_all_unaryapprox_explogs=8_pair'}}
        _C_array = []
        for c in [config1,config2,config3]:
            _C_array.append(config.config_updates(_C, c))              
        ...
        config1 = {'net_params': {'softmax': False, 'losses': 
                                [('MILUnaryParallelApproxSigmoidLoss',
                                  {'angle_params':(-60,61,30), 'mode':'focal', 'method':'expsumr', 'gpower':4},1),
                                 ('MILPairwiseLoss',{'softmax':False, 'exp_coef':-1},10)]},
                   'save_params': {'experiment_name': 'enet_parallel_approx_focal_60_30_expsumr=4_unary_pair'}}
        config2 = {'net_params': {'softmax': False, 'losses': 
                                [('MILUnaryParallelApproxSigmoidLoss',
                                  {'angle_params':(-60,61,30), 'mode':'focal', 'method':'expsumr', 'gpower':6},1),
                                 ('MILPairwiseLoss',{'softmax':False, 'exp_coef':-1},10)]},
                   'save_params': {'experiment_name': 'enet_parallel_approx_focal_60_30_expsumr=6_unary_pair'}}
        config3 = {'net_params': {'softmax': False, 'losses': 
                                [('MILUnaryParallelApproxSigmoidLoss',
                                  {'angle_params':(-60,61,30), 'mode':'focal', 'method':'expsumr', 'gpower':8},1),
                                 ('MILPairwiseLoss',{'softmax':False, 'exp_coef':-1},10)]},
                   'save_params': {'experiment_name': 'enet_parallel_approx_focal_60_30_expsumr=8_unary_pair'}}
        _C_array = []
        for c in [config1,config2,config3]:
            _C_array.append(config.config_updates(_C, c))
        ...
        config1 = {'net_params': {'softmax': False, 'losses': 
                                [('MILUnaryParallelApproxSigmoidLoss',
                                  {'angle_params':(-60,61,30), 'mode':'focal', 'method':'explogs', 'gpower':4},1),
                                 ('MILPairwiseLoss',{'softmax':False, 'exp_coef':-1},10)]},
                   'save_params': {'experiment_name': 'enet_parallel_approx_focal_60_30_explogs=4_unary_pair'}}
        config2 = {'net_params': {'softmax': False, 'losses': 
                                [('MILUnaryParallelApproxSigmoidLoss',
                                  {'angle_params':(-60,61,30), 'mode':'focal', 'method':'explogs', 'gpower':6},1),
                                 ('MILPairwiseLoss',{'softmax':False, 'exp_coef':-1},10)]},
                   'save_params': {'experiment_name': 'enet_parallel_approx_focal_60_30_explogs=6_unary_pair'}}
        config3 = {'net_params': {'softmax': False, 'losses': 
                                [('MILUnaryParallelApproxSigmoidLoss',
                                  {'angle_params':(-60,61,30), 'mode':'focal', 'method':'explogs', 'gpower':8},1),
                                 ('MILPairwiseLoss',{'softmax':False, 'exp_coef':-1},10)]},
                   'save_params': {'experiment_name': 'enet_parallel_approx_focal_60_30_explogs=8_unary_pair'}}
        _C_array = []
        for c in [config1,config2,config3]:
            _C_array.append(config.config_updates(_C, c))
    ...
    for _C_used in _C_array:
        ...
        #     img, target = dataset_test.__getitem__(k)
        # sys.exit()
