...
if __name__ == "__main__":
    ...
    ## fs
    if n_exp==0:
    	experiment_name = 'enet_all_fs'
    ## mil baseline
    elif n_exp==1:	
        experiment_name = 'enet_all_unary_pair'
    ## ablation study - generalized mil
    elif n_exp==2:
        experiment_name = 'enet_parallel_focal_40_10_unary_pair'
    elif n_exp==3:
        experiment_name = 'enet_parallel_focal_40_20_unary_pair'
    elif n_exp==4:
        experiment_name = 'enet_parallel_focal_60_30_unary_pair'
    ## ablation study - smooth max approximation
    elif n_exp==5:
        experiment_name = 'enet_all_unaryapprox_expsumr=4_pair'
    elif n_exp==6:
        experiment_name = 'enet_all_unaryapprox_expsumr=6_pair'
    elif n_exp==7:
        experiment_name = 'enet_all_unaryapprox_expsumr=8_pair'
    elif n_exp==8:
        experiment_name = 'enet_all_unaryapprox_explogs=4_pair'
    elif n_exp==9:
        experiment_name = 'enet_all_unaryapprox_explogs=6_pair'
    elif n_exp==10:
        experiment_name = 'enet_all_unaryapprox_explogs=8_pair'
    ## main results
    elif n_exp==11:
        experiment_name = 'enet_parallel_approx_focal_60_30_expsumr=4_unary_pair'
    elif n_exp==12:
        experiment_name = 'enet_parallel_approx_focal_60_30_expsumr=6_unary_pair'
    elif n_exp==13:
        experiment_name = 'enet_parallel_approx_focal_60_30_expsumr=8_unary_pair'
    elif n_exp==14:
        experiment_name = 'enet_parallel_approx_focal_60_30_explogs=4_unary_pair'
    elif n_exp==15:
        experiment_name = 'enet_parallel_approx_focal_60_30_explogs=6_unary_pair'
    elif n_exp==16:
        experiment_name = 'enet_parallel_approx_focal_60_30_explogs=8_unary_pair'
