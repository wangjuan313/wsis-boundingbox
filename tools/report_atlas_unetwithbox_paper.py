...
if __name__ == "__main__":
    ...
    folders = [## fs
               ...
               'enet_all_unary_pair', 
               ## mil parallel
               'enet_parallel_focal_40_10_unary_pair',
               'enet_parallel_focal_40_20_unary_pair',
               'enet_parallel_focal_60_30_unary_pair',
               ## ablation study - smooth max approximation
               'enet_all_unaryapprox_expsumr=4_pair',
               'enet_all_unaryapprox_expsumr=6_pair',
               'enet_all_unaryapprox_expsumr=8_pair',
               'enet_all_unaryapprox_explogs=4_pair',
               'enet_all_unaryapprox_explogs=6_pair',
               'enet_all_unaryapprox_explogs=8_pair',
               ## main results
               'enet_parallel_approx_focal_60_30_expsumr=4_unary_pair',
               'enet_parallel_approx_focal_60_30_expsumr=6_unary_pair', 
               'enet_parallel_approx_focal_60_30_expsumr=8_unary_pair',
               'enet_parallel_approx_focal_60_30_explogs=4_unary_pair',
               'enet_parallel_approx_focal_60_30_explogs=6_unary_pair', 
               'enet_parallel_approx_focal_60_30_explogs=8_unary_pair',
               ]
